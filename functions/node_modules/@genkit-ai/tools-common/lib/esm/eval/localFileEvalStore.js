...
export class LocalFileEvalStore {
    ...
    async save(evalRun) {
        const fileName = this.generateFileName(evalRun.key.evalRunId, evalRun.key.actionId);
    ...
    async load(evalRunId, actionId) {
        const filePath = path.resolve(this.storeRoot, this.generateFileName(evalRunId, actionId));
    ...
    generateFileName(evalRunId, actionId) {
        if (!actionId) {
