...
exports.promptContinue = exports.cliCommand = exports.ToolPluginSchema = exports.ToolPluginSubCommandsSchema = exports.ToolPluginActionSchema = exports.BaseToolPluginActionSchema = void 0;
...
async function promptContinue(message, dfault) {
    console.log(message);
